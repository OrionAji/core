...
SECRET_KEY = 'django-insecure-rg*gv=q#ggj#%22f!z=k=(jo^yzk$y5vea40*6!@z+_io!(656'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Tactical mission scheduling and readiness tracking for military aviation.',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'loggers': {
        ...
        'sorties': {  # Specific logger for our app
            'handlers': ['file'],
            'level': 'INFO',
            'propagate': True,
        },
